...
unzip rsna-abdominal-trauma-detection-png-pt1.zip -d ./train_images
unzip rsna-abdominal-trauma-detection-png-pt2.zip -d ./train_images
unzip rsna-2023-abdominal-trauma-detection-pngs-3-8.zip -d ./train_images
unzip rsna-abdominal-trauma-detection-png-pt4.zip -d ./train_images
unzip rsna-abdominal-trauma-detection-png-pt5.zip -d ./train_images
unzip rsna-abdominal-trauma-detection-png-pt6.zip -d ./train_images
unzip rsna-abdominal-trauma-detection-pngs-pt7.zip -d ./train_images
unzip rsna-2023-abdominal-trauma-detection-pngs-18.zip -d ./train_images
